...
def _extract_raw(args):
	...
	accepted_nouns = u.load_NOUNS(args.nouns_filename, args.threshold)
...
if __name__ == "__main__":
	...
	parser_extract.add_argument("-t", "--threshold", default=10,
	...
	parser_contexts = subparsers.add_parser("contexts", parents=[parent_parser],
											...
											help='contexts')
	parser_contexts.add_argument("-i", "--input-files-list", default="data_sample/files_input.tsv",
								help="path to file containing list of input files")
